...
public enum FeeCategory
{
	 ...
	 */
	ECONOMIC(Coin.valueOf(5000000)), // 0.05 mBTC
	 ...
	 */
	NORMAL(Coin.valueOf(CoinDefinition.DEFAULT_MIN_TX_FEE.getValue())), // 0.1 mBTC

	/**
	 * Confirms within the next 15 minutes.
	 */
	PRIORITY(Coin.valueOf(CoinDefinition.DEFAULT_MIN_TX_FEE.getValue()*5)); // 0.5 mBTC
